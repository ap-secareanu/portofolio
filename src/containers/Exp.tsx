    ...
    <section id='exp'>
      <div className='container'>
        ...
        <div className='row'>
          ...
          text={['Web Developer ', 
          <a className='underline_animation' href="https://digitalstar.ro" target="_blank" rel='noopener'><span>@ Digital Star</span></a>]}
          ...
          <a className='underline_animation' href="https://romania.cgsinc.com/" target="_blank" rel='noopener'><span>@ CGS Romania</span></a>]}
          ...
          <a className='underline_animation' href="https://www.ubisoft.com/en-us/company/careers/locations/bucharest" target="_blank" rel='noopener'><span>@ Ubisoft Romania</span></a>]}
